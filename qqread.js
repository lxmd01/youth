...
console.log(gold)
if (notifyInterval==1&&gold >= 50000&&task.data.treasureBox.doneFlag==0&&d.getHours()>=9 && d.getHours()<=22)
notify.sendNotify(jsname,tz,'')//显示所有通知

else if (notifyInterval==2&&gold >= 50000&&task.data.treasureBox.doneFlag==0&&d.getHours()>=9 && d.getHours()<=22)
notify.sendNotify(jsname,tz,'')//宝箱领取成功通知

else if (notifyInterval==3&&gold >= 50000&&task.data.treasureBox.doneFlag==0&&d.getHours()>=9 && d.getHours()<=22&&task.data.treasureBox.count==0||task.data.treasureBox.count==15||task.data.treasureBox.count==30||task.data.treasureBox.count==45||task.data.treasureBox.count==60)
