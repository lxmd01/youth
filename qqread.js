...
let qqreadtimeheaderVal,qqreadheaderVal;


qqreadtimeheaderVal=JSON.stringify(Secrets.QQREAD_HEADER)
qqreadheaderVal=JSON.stringify(Secrets.QQREAD_TIMEHEADER)
var tz=''
