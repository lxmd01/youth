...
var qqreadheaderVal = JSON.stringify(process.env.QQREAD_HEADER)
var qqreadtimeurlVal = process.env.QQREAD_TIMEBODY
var qqreadtimeheaderVal = JSON.stringify(process.env.QQREAD_TIMEHEADER)
